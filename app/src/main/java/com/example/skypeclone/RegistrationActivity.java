...
public class RegistrationActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if (continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent")) {
                    ...
                    if (!phoneNumber.equals("")) {
                        ...
                        Toast.makeText(RegistrationActivity.this, "Enter a valid number", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    protected void onStart() {
        ...
        {
            Intent homeIntent = new Intent(RegistrationActivity.this, ContentsActivity.class);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Your phone number has been verified", Toast.LENGTH_SHORT).show();
    ...
    {
        Intent intent = new Intent(RegistrationActivity.this, ContentsActivity.class);
